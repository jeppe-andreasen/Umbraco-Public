<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MultiListEditorHandler.aspx.cs" Inherits="UmbracoPublic.WebSite.handlers.MultiListEditorHandler" %>
<%@ Register src="Controls/MultiListControl.ascx" tagname="MultiListControl" tagprefix="uc1" %>
...
<head runat="server">
    ...
    <script src="/assets/js/multilisteditor.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
    <div>
        <div id="editor" class="multilist-editor" runat="server">
            <uc1:MultiListControl ID="multiListControl" runat="server" />
        </div>
    </div>
    <script type="text/javascript">
        multiListEditor.init();
    </script>
    </form>
</body>
</html>
