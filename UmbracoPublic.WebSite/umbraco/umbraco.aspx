<%@ Page Trace="false" Language="c#" CodeBehind="umbraco.aspx.cs" AutoEventWireup="True" Inherits="umbraco.cms.presentation._umbraco" %>
<%@ Register Src="controls/Tree/TreeControl.ascx" TagName="TreeControl" TagPrefix="umbraco" %>
<%@ Register TagPrefix="cc1" Namespace="umbraco.uicontrols" Assembly="controls" %>
<%@ Register TagPrefix="uc1" TagName="quickSearch" Src="Search/QuickSearch.ascx" %>
<%@ Register TagPrefix="umb" Namespace="ClientDependency.Core.Controls" Assembly="ClientDependency.Core" %>
<%@ Register src="../umbracoextensions/ChangeTemplateButton.ascx" tagname="ChangeTemplateButton" tagprefix="uc2" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="/assets/js/versus-ajax.js"></script>
    ...
    <div style="position: relative;">
        ...
        <div class="topBar" id="topBar">
            ...
            <div class="topBarButtons">
                <uc2:ChangeTemplateButton ID="ChangeTemplateButton1" runat="server" />
